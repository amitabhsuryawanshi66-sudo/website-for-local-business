...
export const V2About = ({ data }) => {
  const { name, about, colors, tokens } = data;

  return (
    <V2Section id="about" className="bg-white section-py overflow-hidden">
      <div className="container-px">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-32 items-center">
          <div className="lg:col-span-5 relative">
            ...
            >
              <div className="text-6xl font-black mb-3 tracking-tighter" style={{ color: tokens.primary }}>05+</div>
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-6">
              ...
              >
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.4em]" style={{ color: tokens.accent }}>{about.title}</span>
              </motion.div>
              <h2
