...
export const V2FAQ = ({ data }) => {
  ...
  return (
    <V2Section id="faq" className="bg-slate-50/50 v2-section-py">
      <div className="v2-container">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-24">
            ...
            <h2 className="text-6xl md:text-[100px] v2-heading">Expert <br/><span className="italic" style={{ color: theme.accent }}>Answers.</span></h2>
          </div>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-white rounded-[3rem] border border-slate-100 overflow-hidden shadow-v2-soft group"
                >
                  <button
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: `2px solid ${isOpen ? theme.primary : '#f1f5f9'}`,
                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="px-10 md:px-14 pb-12">
                          ...
                          <p className="text-xl md:text-2xl v2-body leading-relaxed">
                            {faq.answer}
                          </p>
                        </div>
                      </motion.div>
