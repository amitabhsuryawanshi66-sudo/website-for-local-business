...
export const HowItWorks = ({ data }) => {
  ...
  return (
    <Section id="process" className="bg-slate-900 text-white section-py overflow-hidden">
      <div className="container-px">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-32">
            ...
            <h2 className="text-6xl md:text-[100px] heading-v2 text-white">The journey <br/>to <span className="italic" style={{ color: colors.accent }}>perfection.</span></h2>
          </div>

          <div className="relative">
            {/* V2 Vertical Progress Line */}
              ...
              {process.map((step, index) => (
                ...
                >
                  <div className={`w-full md:w-1/2 md:px-20 text-center ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    ...
                    <p className="text-xl text-slate-400 font-medium leading-relaxed">{step.description}</p>
                  </div>
